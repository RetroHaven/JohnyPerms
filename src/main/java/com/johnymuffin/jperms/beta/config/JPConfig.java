...
public class JPConfig extends Configuration {
    ...
    private void write() {
        ...
        generateConfigOption("chat.enable", true);
        generateConfigOption("chat.format", "<%title %prefix %username%suffix> &f%message");
        generateConfigOption("chat.use-display-names", false);
    }
